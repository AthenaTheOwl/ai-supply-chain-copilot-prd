#!/usr/bin/env python3
"""Voice lint for ai-supply-chain-copilot-prd public-facing copy.

Mirrors the ai-field-brief editorial pattern: hard FAIL rules for phrases
and structures that should not ship, plus WARN rules for AI-cadence
candidates. WARN is non-zero by default; this repo is small enough that
every hit should be fixed or explicitly allowlisted.
